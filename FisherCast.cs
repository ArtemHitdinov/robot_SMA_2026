...
{
    [Bot("FisherCast")] // We create an attribute so that we don't write anything to the BotFactory
    public class FisherCast : BotPanel
    {
        ...
        public FisherCast(string name, StartProgram startProgram) : base(name, startProgram)
        {
            // Create tabs
